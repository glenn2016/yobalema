            ...
            <div class="row">
                <div class="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="text-body px-3" href="https://emmanuelnzaou@gmail.com"><i class="fa fa-envelope mr-2"></i>valerdynguibmbi@gmail.com</a>
                    </div>
                </div>
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                @if (Route::has('login'))
                                    ...
                                    @else
                                    <a href="/creationCompte" class="nav-link dropdown-toggle" data-toggle="dropdown">Compte</a>
                                    <div class="dropdown-menu rounded-0 m-0">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px;">
                                <h4 class="text-white text-uppercase mb-md-3">Bienvenue chez YOBALEMA
</h4>
        ...
        <div class="container-fluid py-5">
            <div class="container">
                ...
                <div class="row me-row content-ct">
                    ...
                    <br>
                    <br>
                    <p style="font-weight:600; color:black;">Activez l’application YOBALEMA
.
                    ...
                    <br>
                    <br>
                    <p style="font-weight:600; color:black;">Votre chauffeur YOBALEMA
,
...
.</h2>
 ...
 est le service VTC à la demande qui
                ...
                <br>
                <br>
                <h2 class="row-title" style="color:#F77D0A">YOBALEMA
 Business</h2>
                <br>
                <br>
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 my-auto showcase-text">
                        <h2>Simplifiez vos déplacements professionnels
                            ...
                            <br>
                        <p class="lead mb-0" back-to-top>Nos solutions YOBALEMA
 Business
        ...
        <div class="container-fluid bg-secondary py-5 px-sm-3 px-md-5" style="margin-top: 90px;">
            <div class="row pt-5">
                <div class="col-lg-3 col-md-6 mb-5">
                    ...
                    <p><i class="fa fa-envelope text-white mr-3"></i>valerdynguibmbi@gmail.com</p>
        ...
        <div class="container-fluid bg-dark py-4 px-sm-3 px-md-5">
            ...
            <p class="m-0 text-center text-body">Designed by <a href="https://htmlcodex.com">Nguimbi</a></p>
        </div>
        <!-- Footer End -->
